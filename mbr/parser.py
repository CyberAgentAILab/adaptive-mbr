...
def get_mbr_parser():
    ...
    # Approximate MBR
    parser.add_argument('--approx_iters', type=int, default=5, help='number of runs for approximate MBR (AMBR is non-deterministic algorithm)')
    parser.add_argument('--approx_budgets', type=int, default=-1, help='budgets for approximate MBR')

    # Pruning MBR
    parser.add_argument('--r_0', type=int, default=4, help='size of the reference set at the first iteration for pruning MBR')
    parser.add_argument('--r_increase', type=int, default=2, help='increase rate of the reference set for pruning MBR')
    parser.add_argument('--pruning_alpha', type=float, default=0.9, help='Hypothesis with win rate less than 1 - pruning_alpha will be pruned')
